...
$(IntermediateDirectory)/rectangle_filled.cpp$(ObjectSuffix): rectangle_filled.cpp $(IntermediateDirectory)/rectangle_filled.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-practica/Week1_opdracht2/rectangle_filled.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/rectangle_filled.cpp$(ObjectSuffix) $(IncludePath)
